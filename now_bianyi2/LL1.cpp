...
void LL1::make_excel(){
    ...
    excel["PDYJ_CS"] = 29;excel["D_||"] = 30;excel["D_&&"] = 30;excel["E_||"] = 36;excel["E_&&"] = 36;
    ...
    excel["C_;"] = 28;excel["D_>"] = 30;excel["D_<"] = 30;excel["D_=="] = 30;excel["D_>="] = 30;excel["D_<="] = 30;
    excel["E_;"] = 36;excel["E_>"] = 36;excel["E_<"] = 36;excel["E_=="] = 36;excel["E_>="] = 36;excel["E_<="] = 36;
    excel["E_+"] = 35;excel["E_-"] = 35;
    excel["F_;"] = 39;excel["F_+"] = 39;excel["F_-"] = 39; excel["F_>"] = 39;excel["F_<"] = 39;excel["F_=="] = 39;
    excel["F_<="] = 39;excel["F_>="] = 39; excel["F_*"] = 38;excel["F_/"] = 38;excel["H_;"] = 22;
}

void LL1::pop(Token &x){
  x.token_num1 = sequence.top();
  sequence.pop();
}
...
void LL1::control(Token* token_now,string begin_signal){
    ...
    while(1){
        pop(x);
        string x1,w1;
        x1 = x.token_num1;w1 = w.token_num1;
        //if(isConstant(w.token_num1)) w.token_num1="CS";
        if(x1.)
        else if(isIdentifier(w.token_num1)) w.token_num1 = "BSF";
        else if(isChar(w.token_num1))w.token_num1 = "ZF";
        cout<<x1<<" "<<w1<<endl;
